  ...
  return (
    <div className="stack-lg">
      <section className="glass-card premium-hero">
        <h2>{t("feedback")}</h2>
        <p className="muted">Simple feedback view: score, key improvements, and next action.</p>
      </section>
        ...
        <>
          ...
          <section className="glass-card">
            ...
            <div className="inline-actions" style={{ marginTop: "0.75rem" }}>
              ...
              <button className="ghost-btn compact" type="button" onClick={() => setShowDetails((s) => !s)}>

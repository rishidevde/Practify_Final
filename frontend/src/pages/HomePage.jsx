import { ArrowRight, BookOpenCheck, Brain, Languages, LineChart, Mail, Mic, MessageCircle, Phone, GraduationCap, Shield, UserPlus } from "lucide-react";
    ...
    <div className="landing-v2">
      ...
      <footer className="landing-footer">
        ...
        <div>
          ...
          <h4 style={{ marginTop: "0.8rem" }}>{t("social")}</h4>
          <p>
            Instagram
          </p>
          <p>
